...
img = ImageTk.PhotoImage(Image.open("E:/ml_project/real_news.png"))
img2 = ImageTk.PhotoImage(Image.open("E:/ml_project/fake_news.jpg"))
label_ans_real = tk.Label(frame3, image = img)
